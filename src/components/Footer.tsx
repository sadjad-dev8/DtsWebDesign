      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-12 border-b border-slate-800 text-right">
          ...
          <div className="lg:col-span-3 space-y-3">
            ...
            <div className="space-y-2.5 text-sm text-slate-400">
              ...
              <div className="flex items-center space-x-2.5 space-x-reverse justify-end">
                <span dir="ltr" className="font-sans text-slate-300 inline-block">+98 (21) 8855-0000</span>
                <Phone className="w-4 h-4 text-[#00D2FF] shrink-0" />
              </div>

              <div className="flex items-center space-x-2.5 space-x-reverse justify-end">
                <span dir="ltr" className="font-sans text-slate-300 inline-block">contact@infra-platform.ir</span>
        ...
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          <div className="flex flex-wrap items-center gap-3">
            <span className="font-bold text-slate-400">استانداردها و تاییده‌ها:</span>
            <span dir="ltr" className="px-2 py-1 bg-slate-800 rounded-xs text-slate-300 font-sans inline-block">ISO 27001 : 2022</span>
