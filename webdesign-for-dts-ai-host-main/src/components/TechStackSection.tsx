            ...
            >
              <div>
                <div className="flex items-center justify-between mb-5 pb-3 border-b border-slate-200/60">
                  ...
                  <span className="text-[11px] font-bold px-2.5 py-0.5 rounded-sm bg-blue-50 text-[#0062BD] border border-blue-100">
                    استاندارد تایید شده
                  </span>
                </div>
                  ...
                  {cat.items.map((item, idx) => (
                    <div key={idx} className="p-3 rounded-sm bg-white border border-slate-200/70 shadow-2xs">
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <span className="text-[10px] font-bold px-2 py-0.5 rounded-sm bg-slate-100 text-slate-700 font-sans">
                          {item.tag}
                        </span>
                      </div>
