      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-black text-slate-900 leading-tight mb-4 font-vazir">
            فرآیند ساختاریافته ۴ مرحله‌ای اجرا
          </h2>
          <p className="text-slate-600 text-lg leading-relaxed">
            فرآیند ۴ مرحله‌ای مهندسی مجموعه ما دقت معماری، شفافیت گزارش‌دهی و استقرار بی‌نقص سامانه‌های کلان را تضمین می‌نماید.
          </p>
        </div>
              ...
              return (
                ...
                >
                  ...
                  <div>
                    ...
                    <span className="block text-xs text-slate-400 mt-0.5">{step.duration}</span>
                  </div>
            ...
            <div className="lg:col-span-7 space-y-4">
              <div className="flex items-center space-x-3 space-x-reverse">
                <span className="text-xs font-bold px-3 py-1 bg-blue-50 text-[#0062BD] rounded-sm border border-blue-100">
                  فاز {activeStep.stepNumber} از ۰۴
                </span>
