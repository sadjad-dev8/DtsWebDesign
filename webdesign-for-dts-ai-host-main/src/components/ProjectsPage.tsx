                  ...
                  <div>
                    ...
                    <div className="relative h-56 overflow-hidden bg-slate-900">
                      ...
                      <div className="absolute top-4 left-4">
                        <span className="inline-flex items-center space-x-1 space-x-reverse px-2.5 py-1 rounded-sm bg-emerald-700 text-white text-[11px] font-bold">
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex flex-wrap gap-1.5 mb-2">
                        {project.techTags.map((tag, idx) => (
                          <span
                            key={idx}
                            className="text-[10px] font-bold px-2.5 py-0.5 rounded-sm bg-slate-100 text-slate-700 border border-slate-200 font-sans"
                          >
                            {tag}
                          </span>
                        ))}
